...
x = keras.layers.Conv2D(64, kernel_size=(2, 2), activation="relu", name="Conv_1")(input) # convolutional layer!
x = keras.layers.MaxPool2D()(x) # pooling layer
x = keras.layers.Conv2D(64, kernel_size=(2, 2), activation="relu", name="Conv_2")(x) # convolutional layer!
x = keras.layers.MaxPool2D()(x) # pooling layer

x = keras.layers.Conv2D(64, kernel_size=(2, 2), activation="relu", name="Conv_3")(x) # convolutional layer!
x = keras.layers.MaxPool2D()(x) # pooling layer

x = keras.layers.Conv2D(64, kernel_size=(2, 2), activation="relu", name="Conv_4")(x) # convolutional layer!
x = keras.layers.MaxPool2D()(x) # pooling layer

x = keras.layers.Conv2D(64, kernel_size=(2, 2), activation="relu", name="Conv_5")(x) # convolutional layer!
x = keras.layers.MaxPool2D()(x) # pooling layer
